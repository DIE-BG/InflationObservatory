...
# !!! Main.UserApp is configured as an alias for Main.InflationObservatory and you might encounter it in some tests
using Main.InflationObservatory, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "InflationObservatory tests" begin
  @includetests ARGS
end
